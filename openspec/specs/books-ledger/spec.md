...
One position ledger parameterised by book, the single paper-execution boundary, and gross portfolio analytics.

Introduced by `books-ledger-and-analytics` (see `openspec/archive/`).
