...
Scoring the book's own structure — concentration, spread, deployment, thesis integrity — and
what to do about it. Never a score about instruments.

Introduced by `portfolio-health-and-actions` (see `openspec/archive/`).
