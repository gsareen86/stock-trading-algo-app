...
async def index(settings: Annotated[Settings, Depends(get_settings)]) -> dict[str, Any]:
    return {
        ...
        "endpoints": {
            ...
            "screen": "POST /screen",
            "cycle": "POST /cycles/run",
            "evaluate": "POST /verdicts/evaluate",
            "verdicts": "GET /verdicts",
            "positions": "GET /books/{book}/positions",
            "trades": "GET /books/{book}/trades",
            "book_analytics": "GET /books/{book}/analytics",
            "book_health": "GET /books/{book}/health",
            "act_on_insight": "POST /insights/{id}/act",
            "fill": "POST /books/{book}/fill",
            "insights": "GET /insights",
            "backtest": "POST /backtest/run",
            "broker_status": "GET /broker/status",
            "broker_connect": "POST /broker/connect",
            "broker_holdings": "GET /broker/holdings",
